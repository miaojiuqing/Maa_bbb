        ...
        try:
            ...
            if (
                ...
                try:
                    ...
                    # 返回int百分比血量
                    print(f"当前必杀技能能量: {current_energy}/{max_energy}")
                    ultimate_energy = int(ultimate_energy_result.best_result.text)
                    print(f"需要必杀技能能量: {ultimate_energy}")
                    if current_energy >= ultimate_energy:
                        return True
                    else:
                        return False
                except ValueError:
